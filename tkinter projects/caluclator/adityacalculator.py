...
import math
screen = Tk()
screen.title("Aditya's Calculator")
screen.configure(bg='dark blue')
screen.maxsize(width='453',height='488')
screen.minsize(width='362',height='488')
screen.resizable(False, False)
screen.iconbitmap(r'C:\Users\adity\Desktop\python projects\tkinter projects\caluclator\calc.ico')
...
btnadd = Button(screen,text='+',font=('arial',20,'italic bold'),bd=8,padx=18,pady=16,command=lambda:click('+'),activebackground='green',activeforeground='white',bg='powder blue')
...
btnsin = Button(screen,text='sin',font=('arial',15,'italic bold'),bd=8,padx=14,pady=20,command=cmsin,activebackground='green',activeforeground='white',bg='powder blue')
btnsin.grid(row=0,column=4)

btncos = Button(screen,text='cos',font=('arial',15,'italic bold'),bd=8,padx=14,pady=20,command=cmcos,activebackground='green',activeforeground='white',bg='powder blue')
btncos.grid(row=1,column=4)

btntan = Button(screen,text='tan',font=('arial',15,'italic bold'),bd=8,padx=16,pady=20,command=cmtan,activebackground='green',activeforeground='white',bg='powder blue')
btntan.grid(row=2,column=4)

btnsqrt = Button(screen,text='sqrt',font=('arial',15,'italic bold'),bd=8,padx=14,pady=20,command=cmsqrt,activebackground='green',activeforeground='white',bg='powder blue')
btnsqrt.grid(row=3,column=4)

btnlog = Button(screen,text='log',font=('arial',15,'italic bold'),bd=8,padx=16,pady=20,command=cmlog,activebackground='green',activeforeground='white',bg='powder blue')
